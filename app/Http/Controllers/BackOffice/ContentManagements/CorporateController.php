...
use App\Http\Requests\BackOffice\ContentManagements\ContentManagementCorporateStoreRequest;
...
class CorporateController extends Controller
{
    ...
    {
        $data = $this->contentManagementRepository->get(ContentManagementCodeKey::CORPORATE, $request->trade_name, true);
        return $this->success($data);
    }

    public function store(ContentManagementCorporateStoreRequest $request)
    {
        try {
            DB::beginTransaction();
            $data = $this->contentManagementRepository->updateCorporate($request);
            DB::commit();
            return $this->success($data);
