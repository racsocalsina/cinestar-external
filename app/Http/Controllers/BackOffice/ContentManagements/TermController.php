...
use App\Http\Requests\BackOffice\ContentManagements\ContentManagementTermStoreRequest;
...
class TermController extends Controller
{
    ...
    {
        $data = $this->contentManagementRepository->get(ContentManagementCodeKey::TERMS, $request->trade_name, true);
        return $this->success($data);
    }

    public function store(ContentManagementTermStoreRequest $request)
    {
        try {
            DB::beginTransaction();
            $data = $this->contentManagementRepository->updateTerm($request);
            DB::commit();
            return $this->success($data);
