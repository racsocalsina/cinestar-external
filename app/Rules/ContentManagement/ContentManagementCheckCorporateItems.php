...
class ContentManagementCheckCorporateItems implements Rule
{
        ...
        foreach($value as $item) {
            ...
            if ($item['action'] == ActionType::CREATE || $item['action'] == ActionType::UPDATE) {
                if (!isset($item['description'])) {
                    $this->errorMessage = "Descripción es requerido";
                    return false;
                }
            }
            ...
            if ($item['action'] == ActionType::CREATE) {
                if (!isset($item['image'])) {
                    $this->errorMessage = "Imagen para el servicio es requerido";
                    return false;
                }
