...
return [
    ...
    */
    ...
    'alpha_spaces'         => 'El campo :attribute debe solo contener letras y espacios.',
    ...
    'claim' => [
        'cellphone_digits_between'        => 'El campo teléfono de contacto debe contener 9 dígitos.',
        'representative_name_required_if' => 'El campo nombre del representante es obligatorio cuando el campo mayor de edad esta seleccionado como No.'
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'password'               => 'contraseña',
        'sede_district_id'       => 'distrito de la zona',
        'claim_type_id'          => 'detalle de su reclamo',
        'identification_type_id' => 'identificación del bien contratado',
        'detail'                 => 'detalle del reclamo',
        'amount'                 => 'monto del reclamo',
        'name'                   => 'nombre',
        'lastname'               => 'apellido',
        'older'                  => 'mayor de edad',
        'document_type_id'       => 'tipo de documento de identidad',
        'document_number'        => 'Número de documento',
        'representative_name'    => 'nombre del representante',
        'address'                => 'dirección',
        'person_district_id'     => 'distrito del reclamante',
        'cellphone'              => 'teléfono',
        'email'                  => 'correo',
